...
namespace InfoPanel.Models
{
    ...
    public partial class ImageDisplayItem : DisplayItem
    {
        ...
        public string? RtspUrl
        {
            ...
            set
            {
                    ...
                    || value.StartsWith("rtsps://"))
                {
                    ...
                    {
                        ImageCacheHook.InvalidateImage?.Invoke(previousValue);
                    }
                }
            }
        }
        ...
        public override SKSize EvaluateSize()
        {
            ...
            {
                if (ImageCacheHook.GetImageSize?.Invoke(this, false) is SKSize cachedSize)
                {
                    if (result.Width == 0)
                    {
                        result.Width = cachedSize.Width;
                    }

                    if (result.Height == 0)
                    {
                        result.Height = cachedSize.Height;
                    }
                }
            }
